...
export default function HeaderTop() {
  ...
  return (
    <>
      <div
        className="p-2 relative lg:text-white overflow-hidden"
        style={{
      ...
      >
        <div className=" pt-3 justify-between flex items-center max-w-[1200px]  mx-auto text-white pb-2 ">
          <a href="" className="items-center text-[0.8rem] font-stretch-50%">
            Email us at : exaple@email.com
          </a>
        ...
        <div className="pt-2 justify-between flex max-w-[1200px]  mx-auto ">
          <div>
            <a href="">
              <img className="w-15 md:w-20" src={logomain} alt="logo" />
            </a>
          </div>
          ...
          <div
            className={`lg:hidden fixed bg-white inset-0 px-3 transition-transform duration-300 ${
              isMenuOpen ? "translate-x-0" : "-translate-x-full"
            }  `}
          >
            <div className="flex justify-between pt-3 ">
              <a className="w-15" href="">
            ...
            <div>
              <ul className="pt-7 text-center capitalize">
                <li className="m-3 p-3 hover:bg-amber-200 rounded-xl">
                  <NavLink to="/">home</NavLink>
                </li>
                <li className="m-3 p-3 hover:bg-amber-200 rounded-xl">
                  <NavLink to="/aboutus">about us</NavLink>
        ...
        <div className=" lg:pt-25 items-center pt-10 max-w-[1200px] mx-auto text-white ">
          <h1 className="justify-self-center text-2xl font-bold">
            {" "}
            Find Your Dream Home{" "}
          </h1>
          <p className="justify-self-center pt-3 md:w-xl text-center text-[0.9rem] font-stretch-50%">
        ...
        <div className=" flex gap-1 pt-9 lg:pt-20 pb-2 lg:pb-10 max-w-[1200px] mx-auto items-center justify-center">
          <img
            className="w-[50px] h-[40px] md:w-[70px] md:h-[50px]"
            src={rent}
            alt=""
          />
          <img
            className="pb-2 w-[50px] h-[40px] md:w-[70px] md:h-[50px]"
            src={sell}
            alt=""
          />
        </div>
      ...
      <div
        className={`max-w-[1200px]  mx-auto ${isMenuOpen ? "hidden" : "show"}`}
      >
        <div className=" lg:flex lg:max-w-[800px]  text-center items-center lg:gap-5   lg:rounded-xl bg-white  lg:absolute md:top-[27rem] justify-items-center lg:left-1/2 transform lg:-translate-x-1/2">
          ...
          <div className="m-3 p-2">
            <button
              type="button "
              className="border  bg-[#4A60A1] rounded-xl md:px-4 md:py-2 px-6 py-1"
            >
              Search
            </button>
          </div>
